...
function draw() {
    ...
    /* Width, Height & Radius for Rects Containing Instructions */
    var whiteWidth = 380;
    var whiteHeight = 90;
    var blueWidth = 370;
    var blueHeight = 80;
    ...
    /* Text for Instructions, Classes, & Description */
    ...
    /* No Stroke For Characters & Blue Background */
    noStroke();
	fill(blueBackground);
    ...
    rect(270, 200, whiteWidth, whiteHeight, boxRadius);
    fill(blueBackground);
    rect(275, 205, blueWidth, blueHeight, boxRadius)

    fill(white);
    textSize(40);
    text(charSelect, 310, 245);

    textSize(20);
    text(moveMouse, 390, 275);
}