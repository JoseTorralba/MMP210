function Button(characters, x, y, audio) {
    ...
    // document.getElementsByTagName("button")[0].setAttribute("id", "democlass");
}
...
function setup() {
    ...
    document.getElementsByTagName("canvas")[0].setAttribute("id", "final-canvas");
    ...
    // text("*/// = No Character Given", 350, 50);
  	...
  	phrase1 = new Button('おはよう (Good Morning)', 155, 440, "audio/goodmorning.mp3");
  	phrase2 = new Button('ありがとうございます (Thank You)', 155, 500, "audio/thankyou.mp3");
  	phrase3 = new Button('ごめんなさい (Sorry)', 155, 560, "audio/sorry.mp3");
  	phrase4 = new Button('すみません (Excuse Me)', 155, 620, "audio/excuseme.mp3");
  	phrase5 = new Button('さようなら (Goodbye)', 155, 680, "audio/goodbye.mp3");
  	phrase6 = new Button('おやすみなさい (Goodnight)', 155, 740, "audio/goodnight.mp3");
